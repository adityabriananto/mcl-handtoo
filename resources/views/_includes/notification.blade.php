...
<div id="toast-success" class="fixed top-4 right-4 z-50 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-green-100 rounded-lg shadow-lg transform transition-transform duration-500 ease-out translate-x-full opacity-0" role="alert">
    ...
    <div class="ms-3 text-sm font-normal">{{ session()->pull('NOTIF_SUCCESS')}}</div>
...
@elseif(session()->has('NOTIF_DANGER'))
<div id="toast-danger" class="fixed top-4 right-4 z-50 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-red-100 rounded-lg shadow-lg transform transition-transform duration-500 ease-out translate-x-full opacity-0" role="alert">
    ...
    <div class="ms-3 text-sm font-normal">{{ session()->pull('NOTIF_DANGER')}}</div>
...
<div id="toast-warning" class="fixed top-4 right-4 z-50 flex items-center w-full max-w-xs p-4 text-gray-500 bg-yellow-100 rounded-lg shadow-lg transform transition-transform duration-500 ease-out translate-x-full opacity-0" role="alert">
    ...
    <div class="ms-3 text-sm font-normal">{{ session()->pull('NOTIF_WARNING')}}</div>
